            ...
            <div class="header-info">
                <div class="container1">
                    <div class="header-info-row">
                        ...
                        <div class="header-info-Free-shipping">Free shipping on international orders of $150+
                        </div>
                        <div class="header-info-log-in">
                            <c:if test="${sessionScope.user != null}">
                                <a href="LoginServlet" class="header-link"><span><i
                                            class="fa-solid fa-user"></i>&nbsp${sessionScope.user.email}</span></a>
                                <span> / </span>
                                <a href="LogoutServlet" class="log-out">Log Out</span></a>
                            </c:if>
                            <c:if test="${sessionScope.user == null}">
                                <a href="LoginServlet" class="header-link"><span><i
                                            class="fa-solid fa-user"></i>&nbspSign in</span></a>
                                        </c:if>
            ...
            <div class="header-menu">
                ...
                <div class="header-menu-wishlist">
                    ...
                    <span>Wishlist</span>
                        ...
                        -->
                        <div class="homelogo">
                            <a href="http://localhost:8080/Do_An/HomeServlet"><img
                        ...
                        <div class="header-menu-option">
                            <form action="SearchServlet" class="search-form">
                                <input type="text" name="key" class="key-search" placeholder="Search...">
                                <button type="submit" class="btn btn-outline-dark">
                                    <i class="fa fa-search"></i>
                                </button>

                            </form>
                            <a href="CartServlet"><span>
                                    <i class="fa fa-shopping-bag menu-text"></i>
                                </span>
                            </a>
                        </div>
                    </div>
